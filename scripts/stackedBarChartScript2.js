...
var svgBar2 = d3.select("#stackedchart2").append("svg").attr("width", window.innerWidth).attr("height", 500),
...
d3.csv("stackedBarChart2.csv", function(d, i, columns) {
  ...
  legendBar2.append("rect")
      .attr("x", width - 19)
      .attr("width", 19)
      .attr("height", 19)
      .attr("fill", z);

  legendBar2.append("text")
      .attr("x", width - 24)
      .attr("y", 9.5)
      .attr("dy", "0.32em")
